...
async function getAudio() {
  ...
  source.connect(analyser); //number of data collect

  analyser.fftSize = 2 ** 10; //pull data off the audio
...
function drawTimeData(timeData) {
  ctx.clearRect(0, 0, WIDTH, HEIGHT); //inject time data into timedata array

  analyser.getByteTimeDomainData(timeData); //visual
